...
enyo.path.addPaths({layout: "/home/josh/Documents/Github/org.webosports.app.memos/enyo/../lib/layout/", onyx: "/home/josh/Documents/Github/org.webosports.app.memos/enyo/../lib/onyx/", onyx: "/home/josh/Documents/Github/org.webosports.app.memos/enyo/../lib/onyx/source/"});
...
storageObject = JSON.parse(localStorage.webOSMemos), enyo.log(storageObject), enyo.log(this.$.ContentPanels.getPanels());
var n = 0;
for (var r in storageObject) p = this.createPanel(), p.$.TitleInput.setValue(storageObject[r].title), p.$.ContentScroller.addStyles("background-color: " + storageObject[r].colour + "!important;"), p.$.MemoText.setValue(storageObject[r].text), n++;
this.$.MenuRepeater.setCount(n), this.$.ContentPanels.reflow();
}
...
var t = this.$.ContentPanels, n = t.createComponent({
kind: "ContentPanel",
...
if (n[t.index + 1]) {
var r = n[t.index + 1].$.TitleInput.getValue();
t.item.controls[0].controls[0].setContent(r);
var i = n[t.index + 1].$.ContentScroller.hasNode().style.backgroundColor;
t.item.controls[0].controls[1].addStyles("background-color: " + i + "!important;");
}
return !0;
},
...
this.createPanel(), this.$.ContentPanels.next(), storageObject[n++] = {
title: "",
colour: "",
text: ""
}, localStorage.webOSMemos = JSON.stringify(storageObject), this.$.MenuRepeater.setCount(n), this.draggable = !0;
},
deleteMemo: function(e) {
delete storageObject[this.$.ContentPanels.getActive().index], this.$.ContentPanels.getActive().destroy(), this.$.ContentPanels.next(), this.$.MenuRepeater.setCount(this.$.ContentPanels.getPanels().length - 1), this.saveMemos(), this.$.MenuRepeater.count == 0 && (this.draggable = !1, this.setIndex(0));
},
panelTitleChanged: function(e, t) {
this.$.MenuRepeater.build(), this.saveMemos();
},
...
this.$.ContentPanels.setIndex(t.index + 1);
}
}), enyo.kind({
name: "EmptyPanel",
layoutKind: "FittableRowsLayout",
